...
const programElementSchema = z.strictObject({
  ...
  module: nonEmptyStringSchema.nullable(),
  ownerId: nonEmptyStringSchema.nullable(),
  ...
  consumerTagName: nonEmptyStringSchema.nullable(),
  consumerPropName: nonEmptyStringSchema.nullable(),
  consumerActionName: nonEmptyStringSchema.nullable(),
  consumerArgumentName: nonEmptyStringSchema.nullable(),
  consumerConditionOperator: nonEmptyStringSchema.nullable(),
  consumerConditionLiteral: nonEmptyStringSchema.nullable(),
  consumerNestedShow: z.boolean().nullable(),
  consumerCollectionName: nonEmptyStringSchema.nullable(),
